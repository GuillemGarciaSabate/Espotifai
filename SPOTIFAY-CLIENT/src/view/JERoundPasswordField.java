 ...
 *
 */
public class JERoundPasswordField extends JPasswordField { 
    private int arcw=10; 
    private int arch=10; 
     ...
     * Constructor
     */
    public JERoundPasswordField() { 
        this.setOpaque(false); 
        this.setBorder(new EmptyBorder(0,5,0,2)); 
     ...
     */
    public JERoundPasswordField(int arcw, int arch,int h) { 
    	this.arcw=arcw;
    	this.arch=arch;
        setOpaque(false); 
     ...
     * 
     * Sets an image
     * @param image Image to set in the RounPasswordField
     */
     ...
     * 
     * Sets an icon
     * @param icon Icon to set in the RoundPasswordField
     */

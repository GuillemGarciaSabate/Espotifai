...
public class TableColumnAdjuster implements PropertyChangeListener, TableModelListener
{
	 ...
	 *  @param table JTable we want to adjust its value
	 */
	...
	/**
	 *  Constructor. Specify the table and spacing
	 *  @param table JTable that we want to adjust in the future
	 *  @param spacing Integer with the amount of spacing we desire
	 */
	 ...
	 *  @param column Integer with the column we want to adjust its size
	 */
	 ...
	 *  @param column Integer with the column we want to calculate the width
	 *  @return Integer with the width of the column header
	 */
	 ...
	 *  given column.
	 *  
	 *  @param column Column we want to check the width of its data
	 *  @return Width of the column based on its data
	 */
	 ...
	 *  @param row Integer with the row of the cell we want to check
	 *  @param column Integer with the column of the cell we want to check
	 *  @return Returns the width of the cell
	 */
	 ...
	 *  @param column Integer with the column we want to update
	 *  @param width Integer with the new width of the column
	 */
	 ...
	 *  @param column Integer with the index of the column that we want to restore its width
	 */
	 ...
	 * @param isColumnHeaderIncluded Boolean that indicates if we include the header in the width calculation
	 */
	 ...
	 * @param isColumnDataIncluded Boolean that indicates if we do include the model data or not
	 */
	 ...
	 * @param isOnlyAdjustLarger Boolean that indicates if columns can be increased in size or not
	 */
	 ...
	 * @param isDynamicAdjustment Boolean that indicates if we want to dynamically recalculate the width
	 */
	 ...
	 * @param e PropertyChangeEvent that we implement
	 */
	 ...
	 * @param e TableModelEvent that we implement
	 */
	 ...
	 *  @param isSelectedColumn Boolean that indicates if the column is selected or not
	 *  @param isAdjust Boolean that indicates if the column is adjusted or not
	 *  @param key String with the info of the keystroke we want to add
	 *  @param keyStroke KeyStroke that we add to the ColumnAction
	 */
	 ...
	 *  @param isToggleDynamic Boolean that indicates if the toggle is dynamic or not
	 *  @param isToggleLarger Boolean that indicates if the toggle is larger or not
	 *  @param key String with the info of the keystroke we want to add
	 *  @param keyStroke KeyStroke that we add to the ColumnAction
	 */
	...
	class ColumnAction extends AbstractAction
	{
    	...
    	/**
    	 * Constructor
    	 * @param isSelectedColumn Boolean that indicates if the column can be selected
    	 * @param isAdjust Boolean that indicates if the column can be adjusted
    	 */
